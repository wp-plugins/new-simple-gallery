...
function nsg_admin_option() 
{
	...
	3.	Past the given code in the posts and pages.<br /><br />
	...
	<h2>About Plugin!</h2>
    Check official website for <a target="_blank" href='http://www.gopiplus.com/work/2010/08/07/new-simple-gallery/'>more info</a>.
	<br />
	<?php
	echo "</div>";
}
...
{
	add_options_page('New simple gallery','New simple gallery','manage_options',__FILE__,'nsg_admin_option');  
}
