...
function nsg_admin_option() 
{
    ...
    <a target="_blank" href='http://www.gopiplus.com/work/2010/08/07/new-simple-gallery/'>Click here</a> to download my other plugins.<br />
...
{
	echo '<p>New Simple Gallery.<br> To change the setting goto New Simple Gallery link under SETTING tab.';
